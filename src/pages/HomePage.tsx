      ...
      {screen === 'home' && (
        <div className={`relative z-10 max-w-7xl mx-auto p-8 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          ...
          <div className="text-center mb-16">
            <h1 className="text-8xl font-black mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent animate-pulse relative z-10">
              StackIt
            </h1>
